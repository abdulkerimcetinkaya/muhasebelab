...
export const RozetToast = ({ rozet, onKapat }: Props) => {
  ...
  return (
    <div className="toast-enter fixed bottom-6 left-1/2 -translate-x-1/2 z-[100] bg-ink text-bg px-5 py-4 shadow-2xl flex items-center gap-4 border-l-4 border-premium rounded-xl">
      <Thiings name="trophy" size={44} />
      <div className="pr-2">
        <div className="text-[9px] tracking-[0.3em] uppercase text-premium mb-0.5 font-semibold">
          Rozet Kazanıldı
        </div>
